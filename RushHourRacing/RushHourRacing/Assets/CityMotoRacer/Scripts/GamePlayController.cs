...
public class GamePlayController : MonoBehaviour
{
	...
	//acess bike run script
		public BIKECamera bikeScript ;
		// Use this for initialization
	//as play game its called	
	void OnEnable ()
		{
				isGameEnded = false;
	...
	//as game end it will show pop up menu with score
		void gameEndMenuActive ()
		{
				gameEndMenu.SetActive (true);
		}

	//as starting game called for city or hill station 
	...
	//first call this as play the game
		void Start ()
		{ 
	...
	//Ranom range generate traffic bikes 
